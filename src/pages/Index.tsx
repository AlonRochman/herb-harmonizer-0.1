...
import {
  ...
  ArrowRight, Activity, Database, Heart, User, Sparkles,
} from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-gradient-to-r from-green-700 to-green-900 rounded-3xl p-8 md:p-12 text-white shadow-lg relative overflow-hidden">
        <div className="max-w-3xl relative z-10">
          ...
          <p className="text-lg text-green-50 mb-8 opacity-90">Evidence-based medical cannabis platform.</p>
        ...
        <Card className="shadow-sm border-slate-200">
          <CardHeader className="pb-3 border-b">
            <CardTitle className="text-lg flex items-center gap-2">
              <Activity className="h-5 w-5 text-blue-600" /> Status
            </CardTitle>
          </CardHeader>
