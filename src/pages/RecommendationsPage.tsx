...
import { fetchFeedbackIndex, scoreStrains } from "@/lib/recommendationEngine";
  ...
  useEffect(() => {
    const generate = async () => {
      ...
      try {
        ...
        // Fetch strains + constraints + feedback index in parallel
        const [{ data: allStrains }, { data: constraintsRow }, feedbackIndex] = await Promise.all([
        ...
        const scored = scoreStrains(
          ...
          conditions, age, thcMax, cbdMin, feedbackIndex
        );
